...
-	[`0.2.0`](https://github.com/sysflow-telemetry/sf-exporter/blob/0.2.0/Dockerfile), [`latest`](https://github.com/sysflow-telemetry/sf-exporter/blob/master/Dockerfile)
