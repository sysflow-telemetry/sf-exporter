...
Our project welcomes external contributions. A good way to familiarize yourself with the codebase and the contribution process is to look for and address issues in the [issue tracker](https://github.com/sysflow-telemetry/sf-exporter/issues).

To contribute code or documentation, please submit a [pull request](https://github.com/sysflow-telemetry/sf-exporter/pulls); and please quickly [get in touch](#communication) with us before embarking on a more ambitious contribution.
...
If you would like to implement a new feature, please [raise an issue](https://github.com/sysflow-telemetry/sf-exporter/issues)
...
If you would like to fix a bug, please [raise an issue](https://github.com/sysflow-telemetry/sf-exporter/issues) before sending a
...
on how to install the application, and dependencies. 

## Testing

This project is in its infancy and with limited resources we have not built a testing framework around the exporter. We hope to do so in the future. 
